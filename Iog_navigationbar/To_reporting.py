...
def reporting():
    reportingtext = driver.find_element(By.XPATH,"//li[@class='ant-typography ant-menu-item ng-star-inserted']//strong[@class='ng-star-inserted'][normalize-space()='Reporting']")
    reportingtext.click()
    time.sleep(5)
    print(driver.title)
...
def verify():
    ...
    exep_title = "Worklenz | Reporting - Overview"

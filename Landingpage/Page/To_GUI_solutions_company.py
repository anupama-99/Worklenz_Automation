...
def guisolutions_company():
    company = driver.find_element(By.XPATH,"//a[@href='https://guisrilanka.com/']//picture//img[@alt='gui']")
    company.click()
    ...
    wait.until(EC.title_contains("GUI Solutions"))

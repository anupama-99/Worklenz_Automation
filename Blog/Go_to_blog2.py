# Boosting Agency Profitability with AI-Driven Task Management
...
def test_blog2(driver):
    wait = WebDriverWait(driver,10)
    blog = wait.until(EC.element_to_be_clickable((By.XPATH,"/html/body/div[1]/main/ul/li[2]/a")))
    blog.click()

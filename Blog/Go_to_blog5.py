# Why Quality Assurance is Key to Worklenz’s Success
...
def test_blog5(driver):
    wait = WebDriverWait(driver,10)
    blog = wait.until(EC.element_to_be_clickable((By.XPATH,"/html/body/div[1]/main/ul/li[5]/a")))
    blog.click()

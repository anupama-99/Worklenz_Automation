# Risks and Rewards of Buying from Big Players-Meta’s Shift
...
def test_go_to_blogs(driver):
    ...
    next_button = wait.until(EC.element_to_be_clickable((By.XPATH,"//a[@title='Go to Next']")))
    next_button.click()

# 05 Best Open-Source Case Management Software for Your Law Firm
def test_blog6(driver):
    wait = WebDriverWait(driver,10)

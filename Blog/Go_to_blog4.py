# How to Save Cost by Using Open Source Task Management Tools?
...
def test_blog4(driver):
    wait = WebDriverWait(driver,10)
    blog = wait.until(EC.element_to_be_clickable((By.XPATH,"/html/body/div[1]/main/ul/li[4]/a")))
    blog.click()

...
def test_recenttacks():
    recendt_button = wait.until(EC.element_to_be_clickable((By.XPATH,"//div[normalize-space()='Recent']")))
    recendt_button.click()

def test_favoritetacks():
